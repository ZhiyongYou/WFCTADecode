					...
					while(statuspackloop)
					{
						...
						switch(status_pack_marker){
							...
							case 0x9:
								...
								pat_full=wfctaDecode->GetPat_Full(buf,packSize);
								pat_nofull=wfctaDecode->GetPat_noFull(buf,packSize);
								nopat_full=wfctaDecode->GetnoPat_Full(buf,packSize);
								nopat_nofull=wfctaDecode->GetnoPat_noFull(buf,packSize);
